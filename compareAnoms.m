...
function compareAnoms
	...
	dataPath = struct('obs','/home/data/obs/PRISM_345/','gcm','/home/data/gcm/ccsm4/', 'save','/home/data/blockLoad/', ...
		'main','/home/ubuntu/files/code/bcsd/blockLoad/testData/CONUStest/', 'matlabRoot','/home/matlabFiles');
	...
	bcsdAnoms = computeBCSDanoms(bcsdPath);
        ...
        metaAnoms.tmin = metaAnoms.tas; metaAnoms.tmax = metaAnoms.tas; metaAnoms.precip = metaAnoms.tas;
