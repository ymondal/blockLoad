...
%% DESCRIPTION: After dowscaling script has been run and results concatenated, this script
%%		creates the derived variables that are used by MaxEnt for species modeling.
%% INPUTS: - none -
%% OUTPUTS: - none -
%%
%% HISTORY:
...
u3_writeAsc(18,P18,0)
u3_writeAsc(19,P19,0)
